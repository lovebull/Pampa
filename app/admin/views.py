...
def user_edit(user_id):
    ...
    if form.validate_on_submit():
        ...
        f = form.avatar.data
        print('form.avatar.data===',form.avatar.data)
        if user.avatar == f:
...
@bp.route('/user/user_delete/<int:user_id>', methods=['GET', 'POST'])
@login_required
...
def account():
    form = CreateUserForm()
    return render_template('admin/setting/account.html',form=form)
